 ...
 *
 */
public class ViewListaIdrVideoSpogli extends Query
{
	 ...
	 */
	public ViewListaIdrVideoSpogli(ConnectionPool arg0)
	{
		super(arg0);
	}
	...
	protected void defWhere()
	{
		...
		this.addWhere("TBLRELRIS.RELRISIDRPARTENZA = TBLRISVIDEO.RISIDR AND ");
		this.addWhere("TBLRISVIDEO.ID_TBLVIDEO = TBLVIDEO.ID_TBLVIDEO");
	}
	...
	protected void defCampi()
	{
		...
		this.addCampi("idTblAudio", "TBLVIDEO", "ID_TBLVIDEO");
	...
	public ResultSet startSelect()
	{
		...
		this.getCampo("videoUsage").setOrderBy(Column.ORDERBY_CRES, 3);
